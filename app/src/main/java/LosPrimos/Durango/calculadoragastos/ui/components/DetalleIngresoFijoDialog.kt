        ...
        Card(
            ...
            Column(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    ...
                    Text(text = ingreso.descripcion ?: "Sin descripción", fontSize = 15.sp, color = Color.Black, lineHeight = 22.sp)
                }
                ...
                if (!ingreso.lugar.isNullOrEmpty()) {
                    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                        ...
                        Text(text = ingreso.lugar, fontSize = 15.sp, color = Color.Black, lineHeight = 22.sp)
                    }
                }
