...
@Composable
fun AgregarIngresoFijoScreen(
    onBack: () -> Unit,
    ingresoViewModel: IngresoViewModel,
    idIngresoEditar: Int? = null
) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                Button(
                    ...
                    Text(if (idIngresoEditar == null) "Guardar" else "Actualizar", fontSize = 14.sp, fontWeight = FontWeight.ExtraBold, color = Color.White)
                }
